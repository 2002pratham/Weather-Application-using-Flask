...
def web3():
	...
	r = requests.get('http://api.openweathermap.org/data/2.5/weather?lat='+latitude+'&lon='+longitude+'&appid=e21cc2e7219febc1b5a37e31bcfded83')
...
def web5():
	...
	r = requests.get('http://api.openweathermap.org/data/2.5/weather?zip='+pincode+',IN&appid=e21cc2e7219febc1b5a37e31bcfded83')
...
def web6():
	...
	r = requests.get('http://api.openweathermap.org/data/2.5/weather?q='+state+',IN&appid=e21cc2e7219febc1b5a37e31bcfded83')
	obj = r.text
	obj1 = json.loads(obj)
	print(obj1)
